...
public class Tris extends JFrame {
	...
	public Tris() {
		...
		panel.setBounds(123, 24, 913, 409);
		...
		O_cover = new Panel();
		O_cover.setBounds(123, 135, 304, 281);
		...
		btnNewButton = new JButton("Nuova partita");
		...
		btnNewButton_1.setIcon(new ImageIcon("F:\\Informatica\\giochijava\\MorraCinese\\homeicon.png"));
		btnNewButton_1.setBounds(10, 47, 101, 23);
